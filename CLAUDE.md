# AI GymTracker — Claude Code context

## What this project is
Single-user personal gym tracker. Marco logs workouts via iOS Shortcut → Supabase Edge Function → Claude API (parses natural language) → Postgres DB. Web app on Netlify for editing the program and viewing past workouts.
